...
namespace postal_project.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityID,Name,StateID,isactive")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityID,Name,StateID,isactive")] Cities cities)
        {
            if (ModelState.IsValid)
            {
